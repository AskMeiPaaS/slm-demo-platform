...
help:
	...
	@echo "make pull-model  - Manually pull $(MODEL_NAME) into Qwen Engine"
...
pull-model:
	@echo "Waiting for Qwen container to be ready..."
	@sleep 5
	@echo "Pulling the $(MODEL_NAME) model. This might take a minute..."
	docker exec -it qwen_3_5_slm ollama run $(MODEL_NAME)
